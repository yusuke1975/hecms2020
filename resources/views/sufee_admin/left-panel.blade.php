                ...
                <li class="menu-item-has-children dropdown">
                    <a href="#" class="dropdown-toggle"
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="menu-icon fa fa-cog"></i>Site
                    </a>
                    <ul class="sub-menu children dropdown-menu">
{{--
--}}
                        <li>
                            ...
                            <a href="{{ route('settings_general') }}"
                               onclick="event.preventDefault();
                                                     document.getElementById('form_settings_general').submit();">
                                <span>General</span>
                            </a>
                            <form id="form_settings_general" action="{{ route('settings_general') }}"
                        ...
                        <li>
                            ...
                            <a href="{{ route('settings_const') }}"
                               onclick="event.preventDefault();
                                                     document.getElementById('form_settings_const').submit();">
                                <span>Const</span>
                            </a>
